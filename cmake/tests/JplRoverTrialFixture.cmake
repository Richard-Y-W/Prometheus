...
file(WRITE "${upstream}/LICENSE" "fixture license\n")
...
run_required("git add" "${GIT_EXECUTABLE}" -C "${upstream}" add LICENSE assembly.step)
run_required(
...
file(SHA256 "${upstream}/LICENSE" license_sha256)
...
if(NOT prepared_files STREQUAL "LICENSE;assembly.step")
  message(FATAL_ERROR
...
elseif(CASE STREQUAL "wrong_license")
  file(SHA256 "${trial}/LICENSE" license_before)
  ...
  file(SHA256 "${trial}/LICENSE" license_after)
