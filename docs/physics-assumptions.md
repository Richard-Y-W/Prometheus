...
These assumptions describe the fixed-input C++ motor-arm conformance demonstrator. They are not a general mechanical model, and the checker does not consume the Program 01A execution-component package until Program 01B.
